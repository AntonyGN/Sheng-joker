jokes = [
    ...
    "PK irudi 4bob",
    "Elections zifanywe kwa FB na Twitter ndio ikuwe cheap. Balance wapatie masufferer.",
    "kama fegi ni 7 bob ambia shopkeeper aivute mpaka ifike ya 5 bob akuuzie",
    "tissue paper itolewe the second sheet. inakuwanga ya nini by the way?",
    "Siku za mwizi ziongezwe zikue ka 68 ju kumekauka.",
